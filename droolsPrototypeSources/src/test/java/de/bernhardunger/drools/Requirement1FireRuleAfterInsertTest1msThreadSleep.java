 ...
 * Events will be fired after a complete insertion of all events.
 * After insertion of dummy events there will be a Tread.sleep() of 1 ms.
 * @author Bernhard Unger
 * 
 */
public class Requirement1FireRuleAfterInsertTest1msThreadSleep {

	Logger logger = LoggerFactory.getLogger(Requirement1FireRuleAfterInsertTest1msThreadSleep.class);
