...
public class RuleGenerator2 {
	...
	public static void main(String[] argv) throws IOException {
		...
		rules.add(HEADER);
		String fileName = "src/main/resources/de/bernhardunger/drools/testRuleMass" + noOfRules + ".drl";
		...
		for (int i = 1; i < noOfRules; i++) {
			...
			String ruleExists = makeRuleExists(i, i+1);
