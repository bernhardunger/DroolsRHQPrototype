 ...
 * 
 */
public class Requirement1FireRuleAfterInsertTest {

	Logger logger = LoggerFactory.getLogger(Requirement1FireRuleAfterInsertTest.class);
	...
	public void start() {
		...
		// Logging is a performance issue, so disabling for exhaustive tests is necessary
